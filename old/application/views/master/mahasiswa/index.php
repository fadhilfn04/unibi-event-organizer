              ...
              <table id="datatable" class="table table-separate table-head-custom table-checkable table-default" style="width: 100%;">
                <thead>
                  <tr>
                    ...
                    <th style="position: sticky; top:0;" class="bg-white all">Nama Mahasiswa</th>
                    <th style="position: sticky; top:0;" class="bg-white all">Universitas</th>
                    <th style="position: sticky; top:0;" class="bg-white all">Fakultas</th>
      ...
      <form id="action-form" action="javascript:;" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="input-npm" placeholder="NPM" name="npm">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="input-email">Universitas</label>
            <input type="text" class="form-control" id="input-email" placeholder="Universitas" name="universitas">
          </div>
          <div class="row">
            <div class="col">
              <div class="form-group">
                <label for="input-id_fakultas">Fakultas</label>
                <select type="text" class="form-control select-fakultas" id="input-id_fakultas" name="id_fakultas">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <select type="text" class="form-control select-jurusan" id="input-id_jurusan" name="id_jurusan">
