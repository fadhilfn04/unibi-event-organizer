            ...
            <table id="datatable" class="table table-separate table-head-custom table-checkable table-default" style="width: 100%;">
              <thead>
                <tr>
                  ...
                  <th style="position: sticky; top:0;" class="bg-white all">Kode</th>
                  <th style="position: sticky; top:0;" class="bg-white all">Nama Fakultas</th>
                </tr>
              </thead>
              <tbody></tbody>
            </table>
    ...
    <div class="modal-content">
      ...
      <form id="action-form" action="javascript:;" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="input-nama">Nama Fakultas</label>
